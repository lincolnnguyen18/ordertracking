...
class TrackViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SubmitButtonDelegate {
    @IBOutlet weak var tableView: UITableView!
    var trackInfo = [[String:Any]]()
    var trackingNum = "580041657280";
    var carrier = "fedex";
    ...
    override func viewDidLoad() {
        ...
        sendRequest() { data in
            DispatchQueue.main.async {
                // self.label.text = data["trackInfo"] as? String
                // self.lastEvent.text = data["lastEvent"] as? String
                self.trackInfo = data;
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.orderNum.text = String(indexPath.count - indexPath.row + 2)
        return cell
    }
}
