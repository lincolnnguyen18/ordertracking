...
#ifndef ORDERTRACKING_SWIFT_H
#define ORDERTRACKING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ordertracking",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13ordertracking11AppDelegate")
...
SWIFT_CLASS("_TtC13ordertracking11PackageCell")
@interface PackageCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified statusDescription;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified checkpointStatus;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified orderNum;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC13ordertracking13SceneDelegate")
...
SWIFT_CLASS("_TtC13ordertracking24SubmitInfoViewController")
@interface SubmitInfoViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified submitButton;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified trackNumInput;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified carrierInput;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC13ordertracking19TrackViewController")
@interface TrackViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (void)closeWithSender:(UIBarButtonItem * _Nonnull)sender;
